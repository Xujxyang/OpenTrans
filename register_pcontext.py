...
stuff_colors459 = [[random.randint(0,255), random.randint(0,255), random.randint(0,255)] for i in range(459)]
...
def register_all_pcontext_59(root):
    ...
    for name, dirname in [("val", "val")]:
        ...
        gt_dir = os.path.join(root, 'annotations_detectron2_ovs', "pc59_val")
...
def register_all_pcontext_full(root):
    ...
    for name, dirname in [("val", "val")]:
        ...
        MetadataCatalog.get(name).set(
            ...
            evaluator_type="sem_seg",
            ignore_label=65535,
            stuff_colors=stuff_colors459,
        )
# /home/siyu.jiao/data/pascal/VOCdevkit/VOC2010/annotations_detectron2_ovs/pc459_val

_root = os.getenv("DETECTRON2_DATASETS", "/home/siyu.jiao/data/pascal/VOCdevkit/VOC2010")
