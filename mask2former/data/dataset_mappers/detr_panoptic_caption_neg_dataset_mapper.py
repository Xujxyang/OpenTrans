...
class DETRPanopticCaptionNegDatasetMapper:
    """
    ...
    def __init__(
        ...
        *,
        ...
        self.all_noun = list(wn.all_lemma_names(pos='n'))
    ...
    def __call__(self, dataset_dict):
        ...
        if self.per_region_super:
            ...
            dataset_name = copy.deepcopy(self.dataset2name[dataset_dict.pop('dataset')])
            negative_name = np.random.choice(self.all_noun, size=300, replace=False)
            dataset_name.extend(negative_name)
            dataset_dict['all_caption'] = tokenize(dataset_name, context_length=77)
        # import pdb;pdb.set_trace()
