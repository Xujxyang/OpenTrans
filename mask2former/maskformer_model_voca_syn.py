...
class OpenSegMaskFormerSyn(nn.Module):
    """
    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            ...
            if self.plain_class_super:
                ...
                cls_pred = torch.bmm(vision_ebmd * logit_scale, plain_class_ebmd)
            ...
            cls_pred = torch.bmm(vision_ebmd * logit_scale, syn_class_ebmd)
            if self.syn_process_each:
                # TODO get gt
