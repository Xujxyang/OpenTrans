...
class OpenSegMaskNoiseFormer(nn.Module):
    """
    ...
    def from_config(cls, cfg):
        ...
        text_embed_dim = cfg.MODEL.TEXT_ENCODER.EMBED_DIM

        text_generator = GMMNnetwork(text_embed_dim, text_embed_dim,
