...
def main(args):
    ...
    if args.eval_only:
        ...
        # load_name = './seed10_imp_mask2for_outbackbone/seg_backbone_imp5.pth'
        # model = torch.load(load_name, map_location="cuda")

        # flops, params = get_model_complexity_info(model.backbone, (3, 512, 512), as_strings=True, print_per_layer_stat=True)
        # print('flops: ', flops, 'params: ', params)
        # flops, params = get_model_complexity_info(model, (3, 512, 512), as_strings=True, print_per_layer_stat=True)
        # flops, params = get_model_complexity_info(model.sem_seg_head.predictor, (2048, 16, 16), as_strings=True, print_per_layer_stat=True)
        # print('flops: ', flops, 'params: ', params)
        ...
        # print(summary(model.sem_seg_head.pixel_decoder, dummy_input, show_input=False, show_hierarchical=False))
